...
export type TextAreaComponentProps = TextInputProps &
  SpacingProps &
  MarginProps &
  DimensionsProps &
  BorderRadiusProps &
...
export const TextArea = memo(
  forwardRef<TextInput, TextAreaComponentProps>(function TextArea(
    {
      padding,
      paddingX,
      paddingY,
      ...
      const s: TextStyle = {
        ...
        marginEnd:
          marginRight === 'auto'
            ...
            : undefined,
        width: width ?? '100%',
        height: height ?? 120, // Default height for textarea
